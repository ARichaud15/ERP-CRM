                ...
                <div class="inner-content">
                    ...
                    <div class="outter-wp">
                        ...
                        <div class="graph-visual tables-main">
                            <h3 class="inner-tittle two" style="text-align: center;"> <i class="fa fa-edit"></i> Editar cliente </h3>
                                    ...
                                    <div class="set-1">
                                        <div class="graph-2 general">
                                            <div class="grid-1">
                                                <div class="form-body">
                                                    <?php 
                                                        $consulta = $db -> query("SELECT * FROM clientes WHERE Numero_clientes = $id");
                                                            ...
                                                            <form action="modificar_clientes.php" method="post">
                                                                ...
                                                                <div class="tables">
                                                                    <table class="table">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td><span>Numero cliente:</span><?php echo $fila[0];?></td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                   <div class="form-group">
                                                                                        <label>Correo</label>
                                                                                        <input type="email" class="form-control" name="correo" autocomplete="off" value="<?php echo $fila[2]; ?>" onkeyup="showHint(this.value)" required>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                                    <div class="form-group">
                                                                ...
                                                                <div class="modal-footer" id="txtHint">
                                                                    <button type="submit" value="Agregar" class="btn btn-primary" id="boton" style="display:none;">Modificar cliente</button>
                                                                </div>
                                                            </form>
                                                    <?php
                                                        }
