    ...
    <body>
                ...
                <div class="inner-content">
                    ...
                    <div class="outter-wp">
                        ...
                        <div class="graph-visual tables-main">
                            <h3 class="inner-tittle two" style="text-align: center;"> <i class="fa fa-address-card-o"></i> Clientes </h3>
                            <h4 class="inner-tittle two" style="text-align: center;"> Total de clientes: <?php echo $rowcount;?> </h4>
                            ...
                            <div class="graph">
                                ...
                                <a>
                                    <input type="text" style="padding:11px; float:center; width:650px; height:49px; margin: 9px" name="filter" value="" id="filter" placeholder="Buscar cliente..." autocomplete="off" />
                                </a>


                                <a>
                                    <button class="btn blue" style="float: right;" data-toggle="modal" data-target="#Modal_agregar"><i class="fa fa-plus"></i> Agregar cliente</button>
                                </a>
                                ...
                                <div class="tables">
                                    <table class="table table-hover table-bordered" id="resultTable" data-responsive="table">
                                        ...
                                        <tbody>
                                            <?php
                                                $consulta = $db -> query( "SELECT * FROM clientes ORDER BY Numero_clientes DESC" );
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a rel="facebox" title="Click para editar los datos del cliente" href="editar_clientes.php?id=<?php echo $fila[0]; ?>"><button class="btn btn-warning"><i class="fa fa-edit"></i></button> 
                                                            </a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="agregar_clientes.php" method="post">
                                                ...
                                                <div class="graph">
                                                    ...
                                                    <div class="tables">
                                                        <table class="table">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td style="text-align: right;"><span>Fecha:</span> <?php echo date('d/m/Y');?> </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table class="table">
                                                            <tbody>
                                                                <tr>
                                                                    <td><span>Nombre</span><input type="text" name="nombre" autocomplete="off" Required/></td>
                                                                </tr>

                                                                 <tr>
                                                                    <td>
                                                                        <span>Correo</span>
                                                                        <input type="email" name="correo" onkeyup="showHint(this.value)" autocomplete="off" Required/>
                                                                    </td>
                                                                    <td>
                                                                        <span>Telefono</span>
                                        ...
                                        <div class="modal-footer" id="txtHint">
                                            <button type="submit" class="btn btn-primary" id="boton" style="display:none;">Agregar cliente</button>
        ...
        <script>
            function showHint(str)
            {
                ...
                xhttp.open("GET", "ajax_correos_clientes.php? dato="+str, true);
                xhttp.send();
            }
        </script>
        <script>
