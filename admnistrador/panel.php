<?php 
    ...
    $result_1 = $db->query("SELECT Id_ventas FROM ventas WHERE Fecha_ventas = '$fecha'");
    $ventas = $result_1-> num_rows;

    $result_2 = $db->query("SELECT Numero_clientes FROM clientes");
    $clientes = $result_2-> num_rows;

    $result_3 = $db->query("SELECT Id_usuarios FROM usuarios");
    $usuarios = $result_3-> num_rows;

    $result_4 = $db->query("SELECT Id_productos FROM productos WHERE Cantidad_productos > 0");
    $productos_e = $result_4-> num_rows;

    $result_5 = $db->query("SELECT Id_productos FROM productos WHERE Cantidad_productos = 0");
    $productos_f = $result_5-> num_rows;

    $result_6 = $db->query("SELECT * FROM proveedores");
    $proveedores = $result_6-> num_rows;

    $result_7 = $db->query("SELECT Id_encuesta FROM encuestas WHERE Fecha_encuesta = '$fecha'");
    $encuestas = $result_7-> num_rows;
...
<html>
    <head>
        ...
        <!-- <script type="text/javascript" src="../js/l.js" async></script> -->
    </head>
                        ...
                        <div class="custom-widgets">
                            <div class="row-one">
                                ...
                                <div class="col-md-3 widget states-last">
                                    ...
                                    <div class="stats-right">
                                        <label><?php echo $productos_e;?></label>
                                    </div>
                                    <div class="clearfix"> </div>   
                                </div>
                                <div class="clearfix"> </div>   
                        ...
                        <div class="custom-widgets">
                            <div class="row-one">
                                <div class="col-md-3 widget">
                                    ...
                                    <div class="stats-right">
                                        <label><?php echo $productos_f;?></label>
                                    </div>
                                    <div class="clearfix"> </div>   
                                </div>
                                ...
                                <div class="col-md-3 widget states-mdl">
                                    ...
                                    <div class="stats-right">
                                        <label><?php echo $proveedores;?></label>
                                    </div>
                                    <div class="clearfix"> </div>   
                                </div>
                                ...
                                <div class="col-md-3 widget">
                                    <div class="stats-left ">
                                        <h4>Encuestas relizadas</h4>
                                    </div>
                                    
                                    <div class="stats-right">
                                        <label><?php echo $encuestas;?></label>
                                    </div>
                                    <div class="clearfix"> </div>   
                                </div>
                                <div class="clearfix"> </div> 
