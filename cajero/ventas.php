                            ...
                            <div class="graph">
                                ...
                                <div class="tables">
                                    <table class="table table-bordered" data-responsive="table">
                                        ...
                                        ?>
                                                <tr class="record">
                                                    ...
                                                    <td><?php $profit=$fila[9]; echo formatMoney($profit, true);?></td>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1"><strong style="font-size: 12px; color: #222222;">
                                                    <?php 
                                                        $total_ganancia = 0;
                                                        $resulta = $db->query("SELECT * FROM ticket WHERE Numero_venta_ticket= '$invoice'");
                                                        @$nfilas = $consulta -> num_rows;

                                                        for($F=0; $F < $nfilas; $F++)
                                                        {
                                                            $fila = $resulta -> fetch_row();
                                                            $total_ganancia += $fila[9];
                                                        }
                                                        echo formatMoney($total_ganancia, true);
                                                    ?>
                                                </td>
                                                <th></th>
                                            </tr>
                                    ...
                                    <?php 
                                        ...
                                        $total_ganancia_aux = $total_ganancia;
